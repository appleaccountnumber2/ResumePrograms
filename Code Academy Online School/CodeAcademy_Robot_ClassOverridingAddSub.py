""" Changing the sub and add methods of a class to when it increments with + it increments a variable instead . I didn't quite understand this... overriding add and sub methods of a CLASS ? what does it do. I will study this to understand it"""
class Robot:
    all_disabled = False
    latitude = -999999
    longitude = -999999
